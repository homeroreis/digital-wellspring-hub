...
-- Fix all other functions that need search_path
...
BEGIN
  ...
  DO UPDATE SET 
    ...
    streak_days = CASE 
      ...
      ELSE 1
    END,
    level_number = calculate_user_level(user_track_progress.total_points + day_points),
  ...
  PERFORM check_and_award_achievements(user_uuid, p_track_slug);
